	...
	return (
		<main className="flex min-h-screen w-full flex-col items-center ">
			...
			<div className="w-full m-4 px-4">
				<section className="relative w-full h-[95vh] flex flex-col items-center justify-between text-center rounded-4xl bg-gradient-to-br from-[#080B36] via-60% via-[#101569B2] to-slate-500">
