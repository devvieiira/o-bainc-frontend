			...
			<section className="mb-[25rem] flex w-full flex-col items-center justify-center gap-y-5">
				...
				<SolutionCard>
					...
					<SolutionCard.Content>
						...
						<SolutionCard.Content.Description>
							Nossa solução de originação automatiza desde o onboarding do
							tomador até a concessão final, integrando dados do CRIP-D®, KYC e
							modelos de risco de forma fluida e segura.
						</SolutionCard.Content.Description>
						<SolutionCard.Content.Features>
				...
				<SolutionCard>
					...
					<SolutionCard.Content>
						...
						<SolutionCard.Content.Description>
							Após a concessão, nossa solução acompanha o comportamento do
							tomador, detecta sinais precoces de inadimplência e atualiza o
							perfil de risco dinamicamente, tudo em conformidade com normas
							regulatórias e com rastreabilidade completa.
						</SolutionCard.Content.Description>
						<SolutionCard.Content.Features>
